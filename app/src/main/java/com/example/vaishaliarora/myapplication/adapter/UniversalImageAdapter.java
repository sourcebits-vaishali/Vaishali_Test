...
import com.example.vaishaliarora.myapplication.util.Constants;
...
public class UniversalImageAdapter extends BaseAdapter {
    ...
    public UniversalImageAdapter(Context context) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.text.setText(String.format(mContext.getString(R.string.item) ,position + 1));

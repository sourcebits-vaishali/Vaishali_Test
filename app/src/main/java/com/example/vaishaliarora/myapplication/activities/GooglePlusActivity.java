...
public class GooglePlusActivity extends AppCompatActivity implements OnConnectionFailedListener, View.OnClickListener, ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign_out_and_disconnect = (LinearLayout)findViewById(R.id.sign_out_and_disconnect);
...
//        getProfileInfo();
    ...
    private void gPlusSignOut() {
        if (google_api_client.isConnected()) {
            google_api_client.clearDefaultAccountAndReconnect().setResultCallback(new ResultCallback<Status>() {
                @Override
